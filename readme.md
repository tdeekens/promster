...
- `http_content_length_bytes`: a Prometheus histogram with the response content length in bytes (defaults to `[ 100000, 200000, 500000, 1000000, 1500000, 2000000, 3000000, 5000000, 10000000, ]`)
